package Registrant_domain_Page;
...
public class Rgst_domain_obj extends Baseclass{
	...
	public void user_validate_domain_page() {
	    String s="Domain ID,Domain Name,Organisation Name,Registration Date,Renewal Date,Status";
	    Table_prop(Table_col, s);
	    List<WebElement> Domain_ID=driver.findElements(By.xpath("(//td[normalize-space()='"+MultiConfigReader.getConfig2Property("Domain")+".bank.in'])[1]/preceding-sibling::td"));
		...
		validatetext(Table_data.get(0), MultiConfigReader.getConfig2Property("Orgname"));
		...
		validatetext(Table_data.get(2), MultiConfigReader.getConfig2Property("Renewal"));
		validatetext(Table_data.get(3), "Inactive");
	...
	public void user_navigates_the_domain_details_page() {
		...
		validatetext(Adomain_name, MultiConfigReader.getConfig2Property("Domain")+".bank.in");
		validatetext(Areg_no, MultiConfigReader.getConfig2Property("submissiondate"));
		validatetext(Aren_date, MultiConfigReader.getConfig2Property("Renewal"));
	...
	public void user_validate_the_domain_domain_details_page() {
		...
		List<WebElement> NS_records=driver.findElements(By.xpath("(//div[contains(@class,'row row-cols-')]//div[contains(text(),'"+MultiConfigReader.getConfig2Property("NS1")+"')])/following::div"));
//		validatetext(NS_records.get(0),MultiConfigReader.getConfig2Property("NS1"));
		validatetext(NS_records.get(0),MultiConfigReader.getConfig2Property("IP1"));
		validatetext(NS_records.get(1),"10");
		validatetext(NS_records.get(4),MultiConfigReader.getConfig2Property("NS2"));
		validatetext(NS_records.get(5),MultiConfigReader.getConfig2Property("IP2"));
	}

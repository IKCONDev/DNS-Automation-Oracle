...
public class Rs_Settings_obj extends Baseclass{
	...
	public void user_validate_the_user_management_page() {
	  ...
	  //"24	venkateshl@ikcontech.com	Charan T	Orgname	Super Admin	Active"
	    Table_prop(table, st);
	    List<WebElement> tabledata=driver.findElements(By.xpath("//td[contains(text(),'"+MultiConfigReader.getConfig2Property("Username")+"')]/following-sibling::td"));
	    validatetext(tabledata.get(0), "Charan T");
	    validatetext(tabledata.get(1), MultiConfigReader.getConfig2Property("Orgname"));
	    validatetext(tabledata.get(2), "Super Admin");
	    validatetext(tabledata.get(3), "Active");
	    WebElement IDs=driver.findElement(By.xpath("//td[contains(text(),'"+MultiConfigReader.getConfig2Property("Username")+"')]/preceding-sibling::td"));
	...
	public void user_navigate_to_officer_details_management_page() {
	    ...
	    validatetext(AO2.get(5), MultiConfigReader.getConfig2Property("admin_email"));
	    validatetext(AO2.get(4), MultiConfigReader.getConfig2Property("admin_phone"));
	    validatetext(AO2.get(3), MultiConfigReader.getConfig2Property("admin_desig"));
	    validatetext(AO2.get(2), MultiConfigReader.getConfig2Property("admin_fname"));
	    validatetext(AO2.get(1), MultiConfigReader.getConfig2Property("Orgname"));
	    ...
	    validatetext(TO2.get(5), MultiConfigReader.getConfig2Property("tech_email"));
	    validatetext(TO2.get(4), MultiConfigReader.getConfig2Property("tech_phone"));
	    validatetext(TO2.get(3), MultiConfigReader.getConfig2Property("tech_desig"));
	    validatetext(TO2.get(2), MultiConfigReader.getConfig2Property("tech_fname"));
	    validatetext(TO2.get(1), MultiConfigReader.getConfig2Property("Orgname"));
	    ...
	    validatetext(BO2.get(5), MultiConfigReader.getConfig2Property("bill_email"));
	    validatetext(BO2.get(4), MultiConfigReader.getConfig2Property("bill_phone"));
	    validatetext(BO2.get(3), MultiConfigReader.getConfig2Property("bill_desig"));
	    validatetext(BO2.get(2), MultiConfigReader.getConfig2Property("bill_fname"));
	    validatetext(BO2.get(1), MultiConfigReader.getConfig2Property("Orgname"));

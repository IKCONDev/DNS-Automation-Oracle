...
public class Registrant_login_object extends Baseclass {
	...
	public void User_Register_An_Account(String username,String Password) throws InterruptedException {
		...
		String stv="Password must be at least 8 characters long, include at least one uppercase letter, one lowercase letter, one digit, and one special character";
		...
		sendkeyweb(Register_username, "Venkat");
		...
		Clickelement(Registration_button);
		popupvalidate("OTP verification successful", "");
	...
	public WebElement org_upload;
		...
		Thread.sleep(4000);
		Clickelement(org_select_file);
		fileupload_robot(MultiConfigReader.getConfig1Property("PAN"));
		Thread.sleep(4000);
		...
		Thread.sleep(4000);
		Clickelement(org_select_file);
		fileupload_robot(MultiConfigReader.getConfig1Property("License"));
		Thread.sleep(4000);
		Selectdropdown(org_doc, "Board Resolution");
		Thread.sleep(4000);
		Clickelement(org_select_file);
		fileupload_robot(MultiConfigReader.getConfig1Property("Board"));
		Thread.sleep(4000);
		clickmultipleweb(Save_next);
	...
	public void User_enters_contact_details(String Name,String Tel,String  Mob,String  Email,String Desig) throws AWTException, InterruptedException {
		...
		fileupload_robot(MultiConfigReader.getConfig1Property("Aadhar"));
		Thread.sleep(4000);
		...
		Clickelement(upload_doc.get(1));
		fileupload_robot(MultiConfigReader.getConfig1Property("ID"));
		Thread.sleep(4000);
	}

Feature: Registrant Onboarding
  ...
  Scenario Outline: Registrant Registration and login
    ...
    Examples: 
      ...
      | prakash@greengolds.com | Test@123 | Valid |
  ...
  Scenario Outline: Onboarding Page
    ...
    Examples: 
      ...
      | greengolds | 500090 | CYBERTOWERS,Madhapur,HEDERABAD,Telangana | 9876542132 | 9876543219 | ikcon@ | 22ABCDE0000A1J5 | ASDEE4455Q | L12345MH2023PLC000001 |
  ...
  Scenario Outline: Technical contact details
    ...
    Examples: 
      | Name   | Tel        | Mob        | Email   | Aadhar         | PAN        | Desig     |
      | srivas | 9685578903 | 9685578941 | ikcon2@ | 1234 5678 7012 | ASDEE4455P | Assig Mng |
  ...
  Scenario Outline: Billing contact details page
    ...
    Examples: 
      | Name  | Tel        | Mob        | Email   | Aadhar         | PAN        | Desig    |
      | raman | 9685578904 | 9685578912 | ikcon3@ | 1234 5678 5012 | ASDEE4455P | Accounts |
  ...
  Scenario Outline: Name server details
    ...
    Examples: 
      ...
      | Office1 | office2 |  | Office3 | office4 | 19.2.7.95 | 19.2.8.96 | 19.2.9.99 | 19.2.7.98 |

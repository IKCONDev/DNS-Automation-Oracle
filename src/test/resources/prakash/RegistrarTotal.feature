Feature: Registrar Operations
  ...
  Scenario Outline: Application
    Then Registrar  check Final "<OrgName>" Functionalities in Applications Page
    Then Registrar  check Final "<DomainName>" Functionalities in Domain Page
    Then Registrar  check Final "<DomainName>" Functionalities in Invoice Page
      | OrgName  | DomainName        |

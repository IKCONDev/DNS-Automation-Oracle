Feature: Registrant Onboarding
  ...
  Scenario Outline: Onboarding Page
    ...
    Examples: 
      ...
      | klm    | 500090 | CYBERTOWERS,Madhapur,HEDERABAD,Telangana | 9685578941 | 9685578945 | ikcon@ | 22ABCDE0000A1J5 | ASDEE4455Q | L12345MH2023PLC000001 |
  ...
  Scenario Outline: Name server details
    ...
    Examples: 
      | NS1     | NS2     | IP1       | IP2       |
      | Office1 | office2 | 1.0.5.25 | 1.0.5.16 |
  ...
  Scenario Outline: Registrant Domain Page
    ...
    Examples: 
      | NS1     | NS2     | IP1       | IP2       |
      | Office1 | office2 | 1.10.5.45 | 1.10.5.39 |
  ...
  Scenario Outline: Registrar  Domain Page
    ...
    Examples: 
      | IP2         | IP1         | Status2          |
      | 199.20.3.73 | 199.20.7.74 | Payment Not Done |

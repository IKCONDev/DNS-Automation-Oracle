...
<<<<<<< HEAD
  ...
  #| bhargavi.prakash@ikcontech.com | Test@123 | Valid |
  #
  ...
  #| ikconiswaraya | 500090 | CYBERTOWERS,Madhapur,HEDERABAD,Telangana | 9685578941 | 9685578945 | ikcon@ | 22ABCDE0000A1J5 | ASDEE4455Q | L12345MH2023PLC000001 |
  #
  ...
  #Examples:
  #| NS1     | NS2     | IP1         | IP2         |
  #| Office1 | office2 | 193.0.21.21 | 193.0.12.12 |
  #
  ...
  #Examples:
  #| NS1     | NS2     | IP1        | IP2        |
  #| Office1 | office2 | 1.10.71.10 | 1.10.81.10 |
  #
...
#
    #Examples: 
      ...
      @3rdstep
    Scenario Outline: Registrant login
    Given User is on Landing Page
    Then User enters "<username>" and "<password>"
  ...
  Scenario Outline: Onboarding Page
    ...
    Examples: 
      | domain | PIN    | Address                                  | Tel        | Mob        | Email | GST             | PAN        | License               |
      | grovy  | 500090 | CYBERTOWERS,Madhapur,HEDERABAD,Telangana | 9685578941 | 9685578945 | foya@ | 22ABCDE0000A1J5 | ASDEE4455Q | L12345MH2023PLC000001 |
  ...
  Scenario Outline: Admin Contact details
    ...
    Examples: 
      | Name   | Tel        | Mob        | Email | Aadhar         | PAN        | Desig   |
      | prasad | 9685578942 | 9685578946 | hoya@ | 1234 5678 8012 | ASDEE4455L | Manager |
  ...
  Scenario Outline: Technical contact details
    ...
    Examples: 
      | Name   | Tel        | Mob        | Email | Aadhar         | PAN        | Desig     |
      | srivas | 9685578943 | 9685578947 | poya@ | 1234 5678 7012 | ASDEE4455P | Assig Mng |
  ...
  Scenario Outline: Billing contact details page
    ...
    Examples: 
      | Name  | Tel        | Mob        | Email  | Aadhar         | PAN        | Desig    |
      | raman | 9685578954 | 9685578948 | tooya@ | 1234 5678 5012 | ASDEE4455P | Accounts |
  ...
  Scenario Outline: Name server details
    ...
    Examples: 
      | NS1     | NS2     | IP1       | IP2        |
      | Office1 | office2 | 1.11.7.14 | 1.11.81.24 |
  ...
  Scenario Outline: Registrant Domain Page
    ...
    Examples: 
      | NS1     | NS2     | IP1       | IP2        |
      | Office1 | office2 | 1.10.7.14 | 1.10.81.24 |
...
=======
  ...
  Examples:
  | username                | password | Case  |
  | bhargavsharma@gmail.com | Test@123 | Valid |
  ...
  Examples:
  | domain        | PIN    | Address                                  | Tel        | Mob        | Email  | GST             | PAN        | License               |
  | chawal | 500090 | CYBERTOWERS,Madhapur,HEDERABAD,Telangana | 9685578941 | 9685578945 | ikcon@ | 22ABCDE0000A1J5 | ASDEE4455Q | L12345MH2023PLC000001 |
 ...
 # 4th step
  ...
  Scenario Outline: Application
    ...
    Examples: 
      ...
      Scenario Outline: Registrantlogin
    Given User is on Landing Page
    #Then User validating the Landing Page
    #When User navigate to Registration Page
    #Then User Register An Account "<username>" "<password>"

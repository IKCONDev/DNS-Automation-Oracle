Feature: Registrant Onboarding
  ...
  | venkat.o@ikbc.com | Test@123 | Valid |
  ...
  | ikbv| ikbv| 500090 | CYBERTOWERS,Madhapur,HEDERABAD,Telangana | 9685578941 | 9685578945 | foya@gmail.com | 22ABCDE0000A1J5 | ASDEE4455Q | L12345MH2023PLC000001 |
  ...
  Examples:
  | NS1     | NS2     | IP1        | IP2        |
  | Office1 | office2 | 1.10.72.13 | 1.10.82.23 |
  ...
  Scenario Outline: Registrar  Domain Page
    ...
    Examples: 
      | IP2        | IP1        | Status3               |
      | 1.10.72.22 | 1.10.82.32 | Approved for payment |

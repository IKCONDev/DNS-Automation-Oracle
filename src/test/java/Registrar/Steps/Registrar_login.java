...
import Registrar.obj.Registrar_LoginObject;
...
public class Registrar_login {
	...
	@Then("Registrar Navigate to Invoice Page can  check {string} Textvalidations")
	public void User_Navigate_to_invoice_Page1(String src) throws Exception {
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(60));
		RLO1.user_navigate_to_Invoicepage1(src);
	
	}
	/*
	@Then("Registrar Navigate to Reports Page can check {string} Textvalidations")

...
//	        validatefont(element);
	...
	public void RClickelement(WebElement element) {
		if (element.isDisplayed()) {
            Clickelement(element); // Assuming this triggers a right-click action
        }
	}
	...
	public void popupvalidate(String str) {
		if(alert_popup.isDisplayed()) {
		String st = alert_popup.getText();
		if(alert_popup.equals(str)) {
			validatetext(alert_popup, str);
			System.out.println(st);
		}
//		else if(alert_popup.equals(srt)){
//		validatetext(alert_popup, srt);
//		System.out.println(st);
//		}
	}

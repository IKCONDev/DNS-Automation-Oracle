...
public class Registrant_login {
	...
	public void user_enters_and(String UN, String string2) throws InterruptedException {
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		RLO.validate_login_page();
		RLO.user_enters_and(UN, string2);

	}

	@Then("User enters the dsc certification details")

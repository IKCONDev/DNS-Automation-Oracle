Feature: Registrant Onboarding
  ...
  Scenario Outline: Onboarding Page
    ...
    Examples: 
      ...
      | ikall | ikall| 500090 | CYBERTOWERS,Madhapur,HEDERABAD,Telangana | 9685578941 | 9685578945 | foya@gmail.com | 22ABCDE0000A1J5 | ASDEE4455Q | L12345MH2023PLC000001 |
  ...
  Scenario Outline: Name server details
    ...
    Examples: 
      | NS1     | NS2     | IP1        | IP2        |
      | Office1 | office2 | 1.10.71.12 | 1.10.81.22 |
